...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { image: @picture.image, lat: @picture.lat, lng: @picture.lng } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { image: @picture.image, lat: @picture.lat, lng: @picture.lng } }
